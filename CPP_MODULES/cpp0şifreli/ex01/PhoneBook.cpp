...
void PhoneBook::ADD()
{
	...
	this->People[this->rsize].SetName(name);
	this->People[this->rsize].SetSurname(surname);
	this->People[this->rsize].SetUsername(username);
	this->People[this->rsize].SetNumber(num);
	this->People[this->rsize].SetSecret(darkestsecret);
	this->rsize++;
}
...
void PhoneBook::SEARCH()
{
	...
	{
    	std::cout << "Enter the password to access People: ";
